...
function App() {
  ...
  const galleryImages = [
    ...
    { src: '/gallery/g-586b01af62e7.jpg', alt: 'Agora Voice Koro', title: 'Koro çalışması' },
    { src: '/gallery/g-b7bcde0eedaf.jpg', alt: 'Agora Voice Koro', title: 'Koro etkinliği' },
    { src: '/gallery/g-6bc8195b930e.jpg', alt: 'Agora Voice Koro', title: 'Koro provası' },
    { src: '/gallery/g-66fe13193452.jpg', alt: 'Agora Voice Koro', title: 'Koro performansı' },
    { src: '/gallery/g-e0013e2e3dec.jpg', alt: 'Agora Voice Koro', title: 'Koro çalışması' },
