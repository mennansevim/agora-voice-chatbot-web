...
function App() {
  ...
  const galleryImages = [
    ...
    { src: '/gallery/img5.jpg', alt: 'Agora Voice Koro', title: 'Koro etkinliği' },
    { src: '/gallery/img6.jpg', alt: 'Agora Voice Koro', title: 'Koro provası' },
    { src: '/gallery/img7.jpg', alt: 'Agora Voice Koro', title: 'Koro performansı' },
    { src: '/gallery/img8.jpg', alt: 'Agora Voice Koro', title: 'Koro çalışması' },
    { src: '/gallery/img9.jpg', alt: 'Agora Voice Koro', title: 'Koro etkinliği' },
    { src: '/gallery/img10.jpg', alt: 'Agora Voice Koro', title: 'Koro provası' },
    { src: '/gallery/img11.jpg', alt: 'Agora Voice Koro', title: 'Koro performansı' },
    { src: '/gallery/img12.jpg', alt: 'Agora Voice Koro', title: 'Koro çalışması' },
    { src: '/gallery/img13.jpg', alt: 'Agora Voice Koro', title: 'Koro etkinliği' },
    { src: '/gallery/img14.jpg', alt: 'Agora Voice Koro', title: 'Koro provası' },
    { src: '/gallery/img15.jpg', alt: 'Agora Voice Koro', title: 'Koro performansı' },
    { src: '/gallery/img16.jpg', alt: 'Agora Voice Koro', title: 'Koro çalışması' },
    { src: '/gallery/img17.jpg', alt: 'Agora Voice Koro', title: 'Koro etkinliği' },
    { src: '/gallery/img18.jpg', alt: 'Agora Voice Koro', title: 'Koro provası' },
    { src: '/gallery/img19.jpg', alt: 'Agora Voice Koro', title: 'Koro performansı' },
  ];
